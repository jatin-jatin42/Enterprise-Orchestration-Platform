...
const DeleteConfirmation: React.FC<DeleteConfirmationProps> = ({ 
  ...
  return (
    <div 
      className="fixed inset-0 bg-black/80 flex items-center justify-center p-3 z-60 backdrop-blur-sm"
    ...
    >
      <div className="bg-gray-800 rounded-lg w-full max-w-xs p-4 border border-gray-700">
        <div className="text-center">
          ...
          <h3 className="text-sm font-semibold text-white mb-1">Delete Resource</h3>
          <p className="text-gray-400 text-xs mb-3">
            Are you sure you want to delete <span className="font-medium text-white">"{resourceTitle}"</span>? This action cannot be undone.
          </p>
